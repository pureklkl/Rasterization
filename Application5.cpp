...
int Application5::Initialize()
{
	...
	GzToken   nameListAA[1];			/* Anti-Aliasing*/
	GzPointer   valueListAA[1];
...
#if 0
		AAFilter aaFilter[AAKERNEL_SIZE] = {
			{ 0., 0., 0.128 },
			{ 0., 0., 0.119 },
			{ 0., 0., 0.294 },
			{ 0., 0., 0.249 },
...
#endif // 0
		nameListAA[0] = GZ_ANTIALISING_FILTER;
		valueListAA[0] = (GzPointer)(aaFilter);
		status |= GzPutAttribute(m_pRender, 1, nameListAA, valueListAA);
...
int Application5::Render() 
{
	...
	*/ 
	...
	if(LEE::getLEE()->getAA()!=NULL)
		LEE::getLEE()->getAA()->setOutput(m_pDisplay);
